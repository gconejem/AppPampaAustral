      ...
      <Grid container spacing={6}>
        <Grid item xs={12} sm={4}>
          <FormControl fullWidth>
            <InputLabel id='status-select'>Área</InputLabel>
            <Select
              fullWidth
              id='select-status'
              label='Status'
        ...
        <Grid item xs={12} sm={4}>
          <FormControl fullWidth>
            <InputLabel id='category-select'>Familia</InputLabel>
            <Select
              fullWidth
              id='select-category'
              value={category}
        ...
        <Grid item xs={12} sm={4}>
          <FormControl fullWidth>
            <InputLabel id='stock-select'>Tipo</InputLabel>
            <Select
              fullWidth
              id='select-stock'
              value={stock}
              onChange={e => setStock(e.target.value as satring)}
              label='Stock'
