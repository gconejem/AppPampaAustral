...
const EditEventSidebar = ({
  ...
  }, [editEventSidebarOpen, fetchEquipos])
      ...
      if (tieneSKU2002) {
        try {
          ...
          if (servicio2003) {
            ...
            // Función auxiliar para formatear fecha para backend preservando tiempo
            ...
            if (seguimientoResponse.ok) {
              toast.success('Visita actualizada exitosamente. Se ha programado automáticamente una visita de seguimiento para 2 días hábiles después.')
            } else {
              toast.success('Visita actualizada exitosamente. Error al crear la visita de seguimiento automática.')
            }
          } else {
            toast.success('Visita actualizada exitosamente. No se pudo encontrar el servicio SKU 2003 para el seguimiento automático.')
          }
        } catch (error) {
