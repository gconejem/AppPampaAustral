...
const AddEquipo = ({ open, handleClose, setData, tiposEquipo, laboratoristas, areas }: Props) => {
    // States
    ...
    const onSubmit = async (data: EquipoFormData) => {
        ...
        try {
            ...
            const response = await axios.post('/api/equipos', payload)
            ...
            const errorMessage = error.response?.data?.error || 'Error al crear el equipo'
    ...
    return (
        ...
        >
            <div className='flex items-center justify-between pli-5 plb-4'>
                <Typography variant='h5'>Agregar Equipo</Typography>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-5'>
                    ...
                    <div className='flex items-center gap-4 pt-4'>
                        <Button variant='contained' type='submit' disabled={isLoading}>
                            {isLoading ? 'Creando...' : 'Agregar Equipo'}
                        </Button>
